    ...
    <table cellspacing="0" cellpadding="0" class="table table-striped">
        ...
        foreach ($list as $lt)
        {
            ...
            <tr>
                ...
                <td><a rel="external" href="/bbs/<?php echo $this->uri->segment(1);?>/view/<?php echo $this->uri->segment(3);?>/board_id/<?php echo $lt->board_id;?>/page/<?php echo $this->uri->segment(5);?>"><?php echo $lt->subject;?></a></td>
